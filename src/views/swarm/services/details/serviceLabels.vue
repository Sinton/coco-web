  ...
  export default {
    ...
    methods: {
      renderData() {
        ...
        this.originalServiceLabels = _.cloneDeep(this.serviceLabels)
      },
      append() {
        const record = {}
        record['editor'] = {}
        record['editable'] = true
        this.serviceLabels.push(record)
        this.changed = true
      },
      save(record) {
      ...
      remove(record) {
        const index = this.serviceLabels.indexOf(record)
      ...
      reset() {
        this.serviceLabels = _.cloneDeep(this.originalServiceLabels)
        this.changed = false
      }
    },
    watch: {
